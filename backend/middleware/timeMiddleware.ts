...
export function timeLogger(req: Request, res: Response, next: NextFunction): void {
  ...
  res.on("finish", () => {
    ...
    logger.info(`${method} ${path} responded ${res.statusCode} in ${executionTime.toFixed(3)}s`);
  });
